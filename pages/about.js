    ...
    return(
        <Layout>
            <article className="prose lg:prose-xl">
                ...
                <p>This website was created with 🖤 by <a href="https://www.kmcginn.dev/" target="_blank" rel="noopener noreferrer">Kevin McGinn</a>. You can find the source code <a href="https://github.com/kmcginn/wicdiv-playlist-explorer" target="_blank" rel="noopener noreferrer">on GitHub</a>.</p>
            </article>
        </Layout>
    );
}